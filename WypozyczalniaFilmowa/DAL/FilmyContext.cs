    ...
    public class FilmyContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Kategoria>().HasData(
                new Kategoria { Id=1, Nazwa="Horror", Opis="Straszne filmy"},
                new Kategoria { Id=2, Nazwa="Dokumentalny", Opis="Filmy oparte na faktach"},
                new Kategoria { Id=3, Nazwa="Thriller", Opis="Dreszczowce"},
                new Kategoria { Id=4, Nazwa="Sensacyjne", Opis="Filmy z akcją"},
                new Kategoria { Id=5, Nazwa="Fantasy", Opis="Elementy magiczne i nadprzyrodzone"}
                );
